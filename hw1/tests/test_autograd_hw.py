...
#     eps = 1e-3
#     gradient_check(ndl.log, ndl.Tensor(np.random.rand(5, 4) + eps))
#     gradient_check(ndl.log, ndl.Tensor(100 * (np.random.rand(5, 4) + eps)))
#     gradient_check(ndl.log, ndl.Tensor(1000 * (np.random.rand(5, 4) + eps)))
